...
<body>
<h2>Money Deposit Form</h2>
<form:form action="depositSave" modelAttribute="account">
<table>
	<tr>
	...
	<tr>
		<td><spring:message code="lbl.depositableAmount"/> :</td>
		<td><form:input path="depositableAmount" size="30" />
		<form:errors path="depositableAmount" cssClass="error"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type="submit" name="btnSubmit" value="Deposit"></td>
	</tr>
</table>
